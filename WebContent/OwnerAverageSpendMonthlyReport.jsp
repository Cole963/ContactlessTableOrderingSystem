...
<html>
   ...
   <body>
      ...
      <div class="row">
         <div class="container">
            <h3 class="text-center">Customer Average Spend Monthly Report</h3>
            <hr>
            <div class = "col-md-6">
               <form action = "viewMonthlyAverageSpendReport" method = "post">			
                  Date: <input type="month" id="selectedMonthVal" class = "form-control" name="selectedMonthVal" onchange = "averageSpendMonthlyCheck();" /> 
               </form>
            </div>
