      ...
      <c:if test="${sessionScope.username != null}">
         <ul class="navbar-nav">
            ...
            <c:if test="${sessionScope.profile == 'Restaurant Owner'}">
               ...
               <li>
                  <a class="nav-link" href="<%=request.getContextPath()%>/viewOwnerFrequencyReport">Frequency</a>
               </li>
               <li>
                  <a class="nav-link" href="<%=request.getContextPath()%>/viewOwnerAverageSpendReport">Average Spending</a>
               </li>
            </c:if>
         </ul>
      </c:if>
